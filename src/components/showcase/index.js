...
const Showcase = () => {
  return (
    <div  className=" pt-[60px] text-white">
      ...
      <iframe width="100%" height="700" src="https://www.youtube.com/embed/5oH9Nr3bKfw?si=sGcp3WY-KeGPbuc2" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
    </div>
  );
};
