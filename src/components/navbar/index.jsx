    ...
    <nav id='main' >
      <div className="container flex item-center text-black justify-between md:justify-stretch md:gap-[400px] text-sm lg:text-lg">
        ...
        <div className="hidden xl:block">
          <ul className="flex items-center gap-[20px] lg:gap-[50px] pt-[60px]  font-light">
            <li  className='cursor-pointer'>
              <Link to='main' spy={true} smooth={true}  >Main</Link>
            </li>
            <li  className='cursor-pointer'>
              <Link to='mentor' spy={true} smooth={true}  >Program</Link>
            </li>
            <li  className='cursor-pointer'>
        ...
        <div className="text-black mt-[25px] xl:hidden" onClick={() => setNavbar(true)}>
          <FaBars size={30} />
        </div>
        <ul
